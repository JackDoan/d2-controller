...
const DeviceVectors exception_table = {
        ...
        .pfnSERCOM2_Handler            = (void*) SERCOM2_DSHOT_InterruptHandler, /* 11 Serial Communication Interface */
        .pfnSERCOM3_Handler            = (void*) SERCOM3_SPI_InterruptHandler, /* 12 Serial Communication Interface */
